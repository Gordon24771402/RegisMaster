...
Selenium webdriver first uses the 127.0.0.1:8080 (mitmproxy) to filter out the potential recognition for a webdriver, then mitmproxy forwards the request to upstream proxy to connect the Internet.
